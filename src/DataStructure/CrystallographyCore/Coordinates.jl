...
StaticArrays.similar_type(::Type{<:ReducedCoordinates}, ::Type{T}, s::Size{(3,)}) where {T} = ReducedCoordinates{T}
StaticArrays.similar_type(::Type{<:CartesianCoordinates}, ::Type{T}, s::Size{(3,)}) where {T} = CartesianCoordinates{T}
